...
# Prueba de aleatoriedad espacial completa {.tabset .tabset-fade .tabset-pills}
...
```{r}
# Graficando accidentes por anio
plot(datos_2019, axes = T, 
     main = 'Accidentes en Barranquilla durante el 2019')
```

## Accidentes 2020

```{r}
plot(datos_2020, axes = T, 
     main = 'Accidentes en Barranquilla durante el 2019')
```
