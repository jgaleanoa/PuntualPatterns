...
# Wrapper para modelo parametrico
...
# }
# 
# env_param <- envelope(datos_ppp_km, Kinhom,
#                       lambda = wrapper_param, nsim = 39)
# saveRDS(env_np, "funciones_segundo_orden/K_np.Rds")
# saveRDS(env_param, "funciones_segundo_orden/K_param")
K_np <- readRDS("funciones_segundo_orden/K_np.Rds")
K_param <- readRDS("funciones_segundo_orden/K_param")
```
