...
```{r}
accidentalidad_19_21<-read.csv("Accidentalidad_en_Barranquilla_2019_.csv", check.names = F, encoding = "UTF-8")
```
...
# saveRDS(coordenadas, "coordenadas.Rds")
coordenadas <- readRDS("coordenadas.Rds")
?geo
```
